...
- **Setup:** Einrichtung des Xcode-Projekts, Git-Repository und des Supabase-Projekts (Tabellen, RLS-Policies).
- **Datenmodellierung:** Definition der Swift-Structs passend zum PostgreSQL-Schema in Supabase.
- **Authentifizierung:** Implementierung der UI und Logik für Login/Registrierung über Supabase.
- **Auftragsverwaltung:** Erstellen der Views zum Anlegen und Verwalten von Hilfsaufträgen.
- **Feed:** Entwicklung der Listenansicht (Map- oder List-View) für verfügbare Aufträge.
- **Chat:** Implementierung der Nachrichten-Ansicht mittels Supabase Realtime.
- **Kamera/QR-Feature:** Integration von AVFoundation zum Generieren und Scannen der Codes.
- **Bewertungssystem:** UI und Logik zur Reputationsberechnung.
- **Testing & Bugfixing:** Testläufe auf Simulatoren und physischen Endgeräten.
